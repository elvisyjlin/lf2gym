...
function keydown(e) { 
	// if(!e) console.log('keydown n: ' + window.event.keyCode + ' / ' + window.event.key);
	// else console.log('keydown: ' + e.keyCode + ' / ' + e.key);
	return master_controller.key(e,1); }
function keyup(e) { 
	// if(!e) console.log('keyup n: ' + window.event.keyCode + ' / ' + window.event.key);
	// else console.log('keyup: ' + e.keyCode + ' / ' + e.key);
	return master_controller.key(e,0); }

window.myKeyDown = keydown;
window.myKeyUp = keyup;
...
master_controller.key = function(e,down)
{
	...
	if( master_controller.block && !isInt(e))
	{
